...
CREATE TABLE IF NOT EXISTS Passenger (
    `Passenger_id` INT,
    `Passenger_name` VARCHAR(8) CHARACTER SET utf8,
    `Category` VARCHAR(7) CHARACTER SET utf8,
    `Gender` VARCHAR(2) CHARACTER SET utf8,
    `Boarding_City` VARCHAR(24) CHARACTER SET utf8,
    `Destination_City` VARCHAR(9) CHARACTER SET utf8,
    `Distance` INT,
    `Bus_Type` VARCHAR(7) CHARACTER SET utf8
);
